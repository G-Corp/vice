-define(OPTIONS, [
  ...
  {effects_file,           global,  "--effects-file",         [{{erlang, is_list}, to_arg}, {{erlang, to_binary}, to_arg}]},
  ...
  {play_rate_arg,          global,  "--play-rate-arg",        [{{erlang, is_list}, to_arg}]},
  ...
  {input_encoding,         input,   "--encoding",             [{{erlang, is_list}, to_arg}]},
  {input_rate,             input,   "--rate",                 [{{erlang, is_integer}, to_karg}]},
