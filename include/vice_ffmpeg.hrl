-define(OPTIONS, [
  ...
  {input_frame_size,       input,  "-s",                     [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
  {input_pixel_format,     input,  "-pix_fmt",               [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
  ...
  {encoder,                output, "-c",                     [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
  {bitrate,                output, "-b",                     [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}, {{erlang, is_integer}, to_arg}]},
  ...
  {filter_script,          output, "-filter_script",         [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]}, % TODO: filename
  {pre,                    output, "-pre",                   [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
  ...
  {output_frame_size,      output, "-s",                     [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
  {aspect,                 output, "-aspect",                [{{vice_prv_options, is_list_and_list}, to_dotargs},
                                                              {{vice_prv_options, is_list_and_float}, to_dotargs}, {{erlang, is_list}, to_arg}, {{erlang, is_float}, to_arg}]},
  ...
  {output_pixel_format,    output, "-pix_fmt",               [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
  {output_sws_flags,       output, "-sws_flags",             [{{erlang, is_list}, to_arg}]},
  {rc_override,            output, "-rc_override",           [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
  {top,                    output, "-top",                   [{{vice_prv_options, is_list_and_integer}, to_dotargs}, {{erlang, is_integer}, to_arg}]},
  {force_key_frames,       output, "-force_key_frames",      [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
  ...
  {sample_fmt,             output, "-sample_fmt",            [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
  ...
  {bitstream_filters,      output, "-bsf",                   [{{vice_prv_options, is_list_and_list}, to_dotargs}, {{erlang, is_list}, to_arg}]},
